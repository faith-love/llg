...
SISMEMBER tag:Java学习资料 用户:1
SMEMBERS tag:Java学习资料
SCARD tag:Java学习资料
SINTER tag:Java学习资料 tag:redis
SUNION tag:Java学习资料 tag:spring
SDIFF follow:用户:1 follow:用户:2
SREM tag:Java学习资料 用户:2
```
...
SINTER follow:用户:1 follow:用户:9
```
...
- 说明为什么大 Set 上直接 `SMEMBERS` 可能造成线上风险。
