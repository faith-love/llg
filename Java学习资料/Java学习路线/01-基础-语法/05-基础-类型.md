...
未译11490tem.out.println(intPrice); // 19
```
...
int a = 5;
int b = 2;
未译11490tem.out.println(a * 1.0 / b); // 2.5
```
...
未译64029 class BasicTypeDemo {
    未译64029 静态资源 未译27462id 主(String[] args) {
        ...
        未译11490tem.out.println(age);
        未译11490tem.out.println(height);
        未译11490tem.out.println(student);
        未译11490tem.out.println(grade);
    }
}
```
