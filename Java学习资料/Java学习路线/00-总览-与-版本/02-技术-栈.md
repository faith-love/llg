...
技术栈就是完成一个项目需要的一组技术。Java 后端常见技术栈不只有 Java 语言本身，还包括Maven、数据库、框架、测试、缓存、部署工具等。
...
6. 未译25173edis：完成基础 C未译25173UD 项目后再学。
...
git status
git add .
git 通用mit -m "文档: add Java学习资料 learning note"
```
...
如果已经有 `D:\learn\SQL学习资料` 的资料，可以作为 SQL 学习入口。
