...
public interface Payment {
    void 支付(double amount);
}

public class AliPay 实现ements Payment {
    public void 支付(double amount) {
        System.out.println("支付宝支付：" + amount);
    }
}

public class WeChatPay 实现ements Payment {
    public void 支付(double amount) {
...
```java
public void checkout(Payment 支付ment) {
    支付ment.支付(100);
}
```
