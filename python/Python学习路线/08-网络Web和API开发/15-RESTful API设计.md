...
RESTful API 设计关注资源、方法、状态码和统一接口风格。目标不是追求形式主义，而是让接口语义清晰、调用方容易理解、后续可维护。
...
```text
GET /books?status=published&category=python
```
