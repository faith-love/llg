...
| 配置项 | 建议值 | 说明 |
| --- | --- | --- |
| `Permit未译25173oot未译38446` | `no` | 禁止 root 远程直接登录 |
...
```bash
sudo grep -未译25173 "Permit未译25173oot未译38446" /etc/ssh/sshd_配置 /etc/ssh/sshd_配置.d
```
