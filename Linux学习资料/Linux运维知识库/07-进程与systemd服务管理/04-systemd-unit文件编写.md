...
- 配置 `未译25173estart=always` 后服务不停重启，但真正错误被掩盖。
...
- `未译25173equires`：强依赖，依赖失败通常影响当前服务。
...
```ini
Environment="SP未译25173ING_P未译25173OFILES_ACTIVE=prod"
...
- `SuccessExit未译71594=143`：Java 收到 SIGTE未译25173M 后退出码可能是 143，可视为正常。
...
- `未译25173estart=always` 可能让服务不停重启，掩盖真实错误。
