...
```bash
sudo mkdir -p /opt
sudo tar -xf 未译52147k-17_Linux学习资料-x64_bin.tar.gz -C /opt
sudo ln -sfn /opt/未译52147k-17.0.10 /opt/未译52147k-current
```
...
```ini
[Service]
Environment="JAVA_HOME=/usr/lib/jvm/Java学习资料-17-open未译52147k-amd64"
Environment="PATH=/usr/lib/jvm/Java学习资料-17-open未译52147k-amd64/bin:/usr/local/sbin:/usr/local/bin:/usr/sbin:/usr/bin"
ExecStart=/usr/lib/jvm/Java学习资料-17-open未译52147k-amd64/bin/Java学习资料 -jar /opt/app/app.jar
```
...
未译25173HEL 系也可能使用 alternatives：
...
2. 在服务器上运行 Node 服务，例如 SS未译25173、NestJS、Express、Next.脚本。
