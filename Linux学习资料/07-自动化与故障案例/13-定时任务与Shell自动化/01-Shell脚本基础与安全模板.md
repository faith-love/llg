...
[[ "$TARGET_DIR" == /opt/apps/demo-接口/releases/* ]] || die "unsafe target: $TARGET_DIR"
rm -rf -- "$TARGET_DIR"
```
...
delete_release() {
  local target="$1"
  local base="/opt/apps/demo-接口/releases"
