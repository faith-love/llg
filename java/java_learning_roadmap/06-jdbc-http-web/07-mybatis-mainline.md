...
> MyBatis 和 MyBatis-Plus 已经拆成独立专章：[05-MyBatis 与 MyBatis-Plus](../05-mybatis-and-plus.md)。本文件保留为本章衔接说明；详细学习请进入 05。
...
| --- | --- | --- | --- | --- |
| MyBatis | 简化 JDBC，同时保留 SQL 控制 | 少写模板代码，但还能看见 SQL | 先掌握单表 CRUD | 重点是理解 Mapper 映射 |
