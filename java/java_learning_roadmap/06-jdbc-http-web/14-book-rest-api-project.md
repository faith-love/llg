...
```text
GET    /api/books?page=1&size=20&keyword=java
GET    /api/books/{id}
POST   /api/books
PUT    /api/books/{id}
DELETE /api/books/{id}
POST   /api/books/{id}/borrowings
POST   /api/books/{id}/returns
```
...
categories: id, name
borrow_records: id, book_id, user_name, borrowed_at, returned_at, status
```
