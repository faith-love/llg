...
```text
D:\learn\Spring学习资料\practice\spring-ioc-practice
```
...
未译64029 interface PaymentService {
    ...
    未译27462id 支付(long orderId, int amount);
}
```
...
```Java学习资料
未译64029 class SmsClient {

    private final String endpoint;

    未译64029 SmsClient(String endpoint) {
...
每个错误都要保留截图或日志片段，并写入 `ioc-未译12785-notes.md`。
